...
class UbootOverlayTest(unittest.TestCase):
    ...
    def test_environment_is_board_local_and_constrained(self) -> None:
        ...
        self.assertIn("qspi_fit_offset=0x00500000", header)
        self.assertIn("qspi_fit_max_size=0x01b00000", header)
        ...
        self.assertIn('"dfu_alt_info=boot.dfu raw 0x00000000 0x00400000\\\\;"', header)
        self.assertIn('"firmware.dfu raw 0x00500000 0x01b00000\\\\;"', header)
