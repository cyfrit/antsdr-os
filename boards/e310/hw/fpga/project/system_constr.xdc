...
# VCXO discipline and external reference interface
...
# AD936x CMOS transmit interface
...
# RF switch controls, global Zynq GPIO 86 through 93
...
create_clock -name vcxo_40m -period 25.000 [get_ports CLK_40MHz_FPGA]
create_clock -name rx_clk -period 16.270 [get_ports rx_clk_in]
