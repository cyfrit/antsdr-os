...
# Zynq-7020 PS7 and board-specific MIO/DDR configuration
...
# Initialize unused interrupt inputs. ad_cpu_interrupt replaces the used nets.
ad_connect sys_concat_intc/dout sys_ps7/IRQ_F2P
for {set i 0} {$i < 16} {incr i} {
  ad_connect sys_concat_intc/In${i} GND
}

# Clock discipline block. The register ABI is fixed at 0x43c00000.
ad_ip_instance axi_e310_vcxo_ctrl axi_e310_vcxo_ctrl
ad_connect CLK_40MHz_FPGA axi_e310_vcxo_ctrl/clk_40m_in
ad_connect PPS_IN axi_e310_vcxo_ctrl/pps_in
ad_connect CLKIN_10MHz axi_e310_vcxo_ctrl/ref_10m_in
ad_connect axi_e310_vcxo_ctrl/dac_mosi CLK_40M_DAC_DIN
ad_connect axi_e310_vcxo_ctrl/dac_sclk CLK_40M_DAC_SCLK
ad_connect axi_e310_vcxo_ctrl/dac_sync_n CLK_40M_DAC_nSYNC

# AD936x CMOS 2R2T interface
...
ad_ip_instance util_vector_logic tx_valid_or [list C_OPERATION {or} C_SIZE 1]
ad_connect tx_valid_or/Op1 tx_fir_interpolator/valid_out_0
ad_connect tx_valid_or/Op2 axi_ad9361/dac_valid_i1
ad_connect tx_valid_or/Res tx_upack/fifo_rd_en
...
# TDD controls RX synchronization and TX unpack reset.
...
ad_ip_instance util_vector_logic ad936x_reset_inv [list C_OPERATION {not} C_SIZE 1]
ad_connect ad936x_reset_inv/Op1 axi_ad9361/rst
ad_connect ad936x_reset_inv/Res axi_tdd_0/resetn
...
ad_ip_instance util_vector_logic tx_reset_or [list C_OPERATION {or} C_SIZE 1]
ad_connect tx_reset_or/Op1 axi_ad9361/rst
ad_connect tx_reset_or/Op2 axi_tdd_0/tdd_channel_2
ad_connect tx_reset_or/Res tx_upack/reset

# AXI register map
ad_cpu_interconnect 0x43C00000 axi_e310_vcxo_ctrl
ad_cpu_interconnect 0x79020000 axi_ad9361
ad_cpu_interconnect 0x7C400000 axi_ad9361_adc_dma
ad_cpu_interconnect 0x7C420000 axi_ad9361_dac_dma
ad_cpu_interconnect 0x7C440000 axi_tdd_0

# Full 1 GiB DDR aperture for both DMA engines.
